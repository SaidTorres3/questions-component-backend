import { Args, ArgsType, Ctx, Field, ID, InputType, Mutation, ObjectType, Query, Resolver } from "type-graphql";
...
export class DeleteQuestionMutation {
  ...
  async deleteQuestion(
    ...
    const question = await connection.manager.findOneOrFail(Question, { where: { uuid: input.questionUuid }, relations: ["answers", "posted_answers"] });
